...
void StateMonitor::onInit() {
  ...
  if (getaddrinfo(hostname.data(), nullptr, &hints, &res) != 0) {
    ROS_WARN_STREAM("[StateMonitor]: Failed to resolve " << hostname.data()
...
tracker_state_t StateMonitor::parse_tracker_state(mrs_msgs::ControlManagerDiagnostics::ConstPtr control_manager_diagnostics) {
  ...
  case mrs_msgs::TrackerStatus::STATE_INVALID:
    return tracker_state_t::INVALID;
  case mrs_msgs::TrackerStatus::STATE_IDLE:
    return tracker_state_t::IDLE;
  case mrs_msgs::TrackerStatus::STATE_TAKEOFF:
    return tracker_state_t::TAKEOFF;
  case mrs_msgs::TrackerStatus::STATE_HOVER:
    return tracker_state_t::HOVER;
  case mrs_msgs::TrackerStatus::STATE_REFERENCE:
    return tracker_state_t::REFERENCE;
  case mrs_msgs::TrackerStatus::STATE_TRAJECTORY:
    return tracker_state_t::TRAJECTORY;
  case mrs_msgs::TrackerStatus::STATE_LAND:
...
uav_state_t StateMonitor::parse_uav_state(mrs_msgs::HwApiStatus::ConstPtr hw_api_status,
...
mrs_robot_diagnostics::SystemHealthInfo StateMonitor::parse_system_health_info(mrs_msgs::UavStatus::ConstPtr uav_status, sensor_msgs::NavSatFix::ConstPtr gnss,
                                                                               sensor_msgs::MagneticField::ConstPtr magnetic_field) {
